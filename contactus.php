...
<head>
  ...
  <title>ASK Realtor | Contact Us</title>
  ...
  <div class="container-fluid p-0 m-0 bg-bprop pb-3">
    <div class="container pt-3">
      ...
      <p class="px-3 mx-3 text-center">
        ASK Realtor is one of the most professional Real Estate
    ...
    <div class="row align-items-start">
      ...
      <div class="col-6 bg-bprop">
        <p class="p-3 text-start">
          ASK Realtor is a Kolkata based Real Estate Agency. We provide the best service and the credit goes to our
          founder Ms. Aastha. Our partners always ready to help you to buy, sell or rent properties if you have any
          query regarding this, our experts are eagerly waiting to give you the best solution to your queries.
          Feel free to contact us.

        </p>
        <h6 class="pb-1">Contact ASK Realtor, Kolkata</h6>
        <ul class="list-group list-group-flush pb-2">
          <li class="list-group-item text-start bg-bprop">
            Email: &nbsp;<a href="mailto:askrealtor@gmail.com">askrealtor@gmail.com</a>
          </li>
          <li class="list-group-item text-start bg-bprop">
